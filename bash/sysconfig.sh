...
function error-message {
  ...
  echo "There is been an error during execution of script!" >&2
...
function error-exit {
  ...
  echo "There is been an error during execution of script! $?"
  exit
...
function displayhelp {
  ...
  echo "
printing help for this script. Options: -

(-h | --help)  for the help
(--host)       for the host information
(--ipconfig)   for ip information
(--os)         for Operating System information
(--domain)     for domain information
(--cpu)        for CPU information
(--memory)     for Memory information
(--disk)       for Disk information
(--printer)    for Printer information
...
function cleanup {
  ...
  rm /tmp/*.$$ && echo "TMP Cleared for this process"
  exit
